...
There are several ways to install and run Harness. The most common, which may not be the easiest, is described in the [Install section](docs/intall.md). This is a guide to installation on the OS of a server. 
